...
WebUI.verifyElementVisible(findTestObject('SelectBook/booklist'))

WebUI.setText(findTestObject('SelectBook/searchbook'), bookTitle)
...
if (testType == 'P') {
    ...
    WebUI.comment('❌ Hasil TIDAK ditemukan ')
}
